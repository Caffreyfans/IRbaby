...
boolean irmqttIR::sendIR(String topic, String command, boolean test) {
  ...
  do {
    ...
    count++;
    switch(count) {
      case 3: string_topic.device_type = tmp; break;
      case 4: string_topic.filename = tmp; break;
      case 5: string_topic.set_type = tmp; break;
    }
